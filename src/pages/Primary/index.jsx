                        ...
                        <div className='mt-28 bg-white rounded-l-lg  h-screen  w-96'>
                            ...
                            <Board id='tols' className='ml-5'>
                                ...
                                <div className='mt-5 pr-5'>
                                    ...
                                    <input type="text" placeholder='texte ici' className='bg-gray-300 mt-2 w-60 h-7 px-5 rounded-xl' />
                                ...
                                <div className="mt-5 flex flex-col">
                                    ...
                                    <input type="text" placeholder="code coleur" id='colorInputText' className="ml-2 bg-gray-300 rounded-xl w-28 h-7 px-3"/>

                                </div>
                                <button className='mt-2 bg-slate-900 w-40 h-10 text-white rounded-xl ml-15'>Modifier</button>
                            </Board>
